...
1. Open the `config/google.js` file and change `YOURCLIENTID` to your Client ID
   value.
1. Run the Arcova Viewer using the config/google.js configuration file
...
The Arcova Viewer Docker container can be connected to Google Cloud Healthcare by
