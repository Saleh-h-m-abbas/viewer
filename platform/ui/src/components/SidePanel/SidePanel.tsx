...
const SidePanel = ({ side, className, activeTabIndex: activeTabIndexProp, tabs, onOpen }) => {
  ...
  // const [pSex, setPSex] = useState<any>();
  // const [pMrn, setPMrn] = useState<any>();
  ...
  const UserData = () => {
    ...
    return (
      <>
        {/* Saleh Abbas Spical Card */}
        {side === 'left' && (
          <div
            // Saleh Abbas
            style={{ backgroundColor: '#161c24', marginBottom: '4px' }}
            ...
            <div className="mb-1 grid grid-cols-3 gap-3">
              <div>
                <span
                  ...
                  style={{ color: '#4189bd', fontSize: 'small' }}
                >
                  {t('Sex')}
                </span>
                <span
